...
export default function Wall({ setSection, hoveredObject, setHoveredObject}) {
  ...
  return (
    ...
    >
      ...
      <Window setSection={setSection} hoveredObject={hoveredObject} setHoveredObject={setHoveredObject}/>
    </mesh>
  );
}
